...
void MenuSence::preloadMusic() {
	auto audio = SimpleAudioEngine::getInstance();

	audio->preloadBackgroundMusic("music/start_bgm.mp3");
	audio->preloadEffect("music/pass_scene.wav");
}

void MenuSence::playBGM()
{
	SimpleAudioEngine::getInstance()->playBackgroundMusic("music/start_bgm.mp3", true);
}

void MenuSence::changeM()
{
	SimpleAudioEngine::getInstance()->playEffect("music/pass_scene.wav", false, 1.0f, 1.0f, 1.0f);
}
